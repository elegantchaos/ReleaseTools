...
Keep the source root for application-level coordination. Group supporting types by responsibility in subfolders, while retaining one source file per type.
